...
-- 	local match_win_pos_list = get_match_win_pos_list(wins, current_win_pos, Action[action].match_condition)
--
-- 	local final_win_pos = get_final_win_pos(match_win_pos_list, current_win_pos, Action[action])
--
...
-- 		if
-- 			final_win_pos.start_row == current_win_pos.start_row
-- 			and final_win_pos.end_row == current_win_pos.end_row
-- 		then
...
-- 		if
-- 			final_win_pos.start_col == current_win_pos.start_col
-- 			and final_win_pos.end_col == current_win_pos.end_col
-- 		then
-- 			change_layout(current_win_id, final_win_pos.win)
-- 			-- require("windows-layout.exchange").exchange(current_win_id, final_win_pos.win)
-- 			return true
