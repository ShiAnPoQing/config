return {
	...
	config = function()
		...
		vim.g.vimtex_view_general_viewer = "E:/SumatraPDF/SumatraPDF.exe"
    ...
    let g:vimtex_compiler_latexmk = {
      ...
      if search('!TEX\s+program\s*=\s*luatex', 'nw')
		...
		-- vim.keymap.set({ "x", "o" }, "wc", "<Plug>(vimtex-ac)")
		-- vim.keymap.set({ "x", "o" }, "we", "<Plug>(vimtex-ae)")
		-- vim.keymap.set({ "x", "o" }, "ec", "<Plug>(vimtex-ic)")
		-- vim.keymap.set({ "x", "o" }, "ee", "<Plug>(vimtex-ie)")
		-- vim.keymap.set({ "x", "o" }, "em", "<Plug>(vimtex-im)")
		-- vim.keymap.set({ "x", "o" }, "eP", "<Plug>(vimtex-iP)")
		-- vim.keymap.set({ "x", "o" }, "e$", "<Plug>(vimtex-i$)")
		-- vim.keymap.set({ "x", "o" }, "ed", "<Plug>(vimtex-id)")
