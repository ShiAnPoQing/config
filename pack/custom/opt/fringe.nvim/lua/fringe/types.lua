...
--- @alias Fringe.ComponentFC<T> fun(component: T)

--- @class Fringe.Component
--- @field useState fun(states: table<string, any>)
--- @field useTemplate fun(templates: table<string,  Fringe.ComponentFC<Fringe.Component>>)
--- @field Text fun(text: string)
--- @field Highlight fun()

--- @class Fringe.Template: Fringe.Component
--- @field Slot fun()

--- @class Fringe.TablineComponent: Fringe.Component

--- @class Fringe.StatuslineComponent: Fringe.Component

--- @class Fringe.TemplateComponent: Fringe.Component
